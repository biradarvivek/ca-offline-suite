...
const data = [
    { type: 'Home Loan / Balance Transfer', amount: 905000, rate: '0.45%', value: 4072.5 },
    { type: 'Loan Against Property / Balance Transfer', amount: 763000, rate: '0.65%', value: 4959.5 },
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <TableHead className="text-right">Commission (in Rs)</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        {data.map((item, index) => (
